...
printf '{"schemaVersion":11,"unityProjectPath":"."}\n' > "$root_repository/.build/build_request.json"
...
printf '{"schemaVersion":11,"unityProjectPath":"Games/Foo"}\n' > "$nested_repository/.build/build_request.json"
...
printf '{"schemaVersion":10,"unityProjectPath":"KnitFactory"}\n' > "$nested_repository/.build/build_request.json"
...
printf '{"schemaVersion":11,"unityProjectPath":"../outside"}\n' > "$nested_repository/.build/build_request.json"
...
printf '{"schemaVersion":11,"unityProjectPath":"LinkedProject"}\n' > "$nested_repository/.build/build_request.json"
