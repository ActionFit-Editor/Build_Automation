...
- `.github/scripts/notify-slack-build-result.sh`: sends optional Android/iOS BuildCommit result notifications to Slack from the runner local webhook file.
...
6. Test Android first, then iOS, then Both.
