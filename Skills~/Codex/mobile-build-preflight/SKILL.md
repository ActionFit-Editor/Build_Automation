...
5. Check whether the repository workflow references `vars.UNITY_RUNNER_AFFINITY_LABEL`; report that the matching repository variable and `project-*` runner label must exist, but do not query, create, or change runner labels or repository variables.
